...
class interface_with_opStatus(AliasPlugin):
    "The interface usage report with operational status"
    ...
    def getColumns(self):
        return [
                ...
                Column('operStatus', PythonColumnHandler('component.getOperStatusString()')),
                Column('adminStatus', PythonColumnHandler('component.getAdminStatusString()')),
